  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        isSeries ? FollowSeries(page: widget.page, limit: widget.limit, params: widget.params) :
        FollowPost(page: widget.page, limit: widget.limit, isQuestion: false, params: widget.params)
      ],
    );
  }
}